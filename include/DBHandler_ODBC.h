...
public:
    ...
    int updateTaskInfo(std::string callid, std::string rxtx, std::string counselorcode, char state, int fsize=0, int plen=0, int wtime=0, const char *tbName="TBL_JOB_INFO", const char *errcode=nullptr, const char *svr_nm="DEFAULT");
    ...
    int updateTaskInfo4Schd(std::string callid, std::string rxtx, std::string tbName);
